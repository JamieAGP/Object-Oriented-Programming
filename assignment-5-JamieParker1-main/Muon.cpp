...
Muon::Muon(std::unique_ptr<FourMomentum> four_momentum, bool is_isolated, bool is_antiparticle)
    : Lepton("muon", -1, std::move(four_momentum), is_antiparticle), is_isolated(is_isolated) {} // Muons have a charge of -1

// Constructor for Muon with label
Muon::Muon(const std::string &label, std::unique_ptr<FourMomentum> four_momentum, bool is_isolated, bool is_antiparticle)
    : Lepton("muon", label, -1, std::move(four_momentum), is_antiparticle), is_isolated(is_isolated) {} // Muons have a charge of -1
